import { Code2, Palette, Zap, User, Bug } from "lucide-react";
...
export default function About() {
  const programmingSkills = [
    ...
    { name: "Laravel", icon: SiLaravel, color: "#ff0000" },
    { name: "Next.js", icon: SiNextdotjs, color: "#FFFFFF" },
    { name: "Node.js", icon: SiNodedotjs, color: "#339933" },
    { name: "PostgreSQL", icon: SiPostgresql, color: "#4169E1" },
    { name: "MongoDB", icon: SiMongodb, color: "#47A248" },
    { name: "Oracle", icon: SiOracle, color: "#eb4034" },
    { name: "Playwright", icon: "public/images/playwright.png", color: "#06B6D4" },
    { name: "Selenium", icon: SiSelenium, color: "#2b8a29" },
    { name: "Pega Platform", icon: "public/images/pega.png", color: "#1b0c57" },
    ...
    <AnimatedContent>
      <section className="py-20 px-6 md:px-12 lg:px-24 bg-gradient-to-b from-slate-950 to-slate-900 overflow-hidden">
        <div className="max-w-7xl mx-auto">
          ...
          {/* <div className="grid md:grid-cols gap-8 mb-12 items-start"> */}
          {/* Left: Who I am */}
            ...
            <div className="relative">
              ...
              <div className="relative">
                <p className="text-gray-300 mb-6 leading-relaxed">
                  ...
                  responsive and stable web and mobile interfaces. I also master
                  Python and SQL for data processing, backend integration, and
                  basic analytics. Furthermore, I have expertise in UI design
                  and experience connecting front-end applications with RESTful
                  APIs and backend services. I am capable of developing and
                  integrating AI-based solutions into mobile applications to
                  deliver smarter, more efficient, and automated user
                  experiences.
                </p>
                ...
                <div className="space-y-3 mb-6">
                  ...
                  <div className="flex items-start gap-3 group/item hover:translate-x-2 transition-transform duration-300">
                    <div className="w-10 h-10 rounded-lg bg-purple-500/10 flex items-center justify-center group-hover/item:bg-purple-500/20 transition-colors">
                      <Bug className="w-5 h-5 text-red-400 group-hover/item:scale-110 transition-transform" />
                    </div>
                    <div>
                      <h4 className="text-white font-semibold mb-1">
                        Tester
                      ...
                      <p className="text-gray-400 text-sm">
                        Testing web applications to ensure quality and reliability
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="mt-8 bg-gray-900/40 border border-gray-800 rounded-2xl p-8 hover:border-purple-500/50 transition-all duration-500 hover:shadow-lg hover:shadow-purple-500/10 animate-slideInRight group">
            <div className="relative">
                      ...
                      >
                        ...
                        {typeof tech.icon === "string" ? (
                          <img
                            src={tech.icon}
                            alt={tech.name}
                            className="w-5 h-5 object-contain group-hover/tech:scale-125 group-hover/tech:rotate-12 transition-all duration-300"
                          />
                        ) : (
                          <tech.icon
